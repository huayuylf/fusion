 ...
 * 娉細chrome銆乻afari銆両E9鍙婁互涓婃祻瑙堝櫒锛屾牳蹇冪殑浠ｇ爜涓昏鏉ヨ嚜浜庣涓夋柟heatmap.js銆侤author juyang
 */
T.HeatmapOverlay = T.Overlay.extend({
    ...
    onAdd: function (map) {
        ...
        if (!this.isSupportCanvas()) {//鍒ゆ柇鏄惁鏀寔Canvas.
            return el;
        }
    ...
    /*==============================浠ヤ笅閮ㄥ垎涓篽eatmap.js鐨勬牳蹇冧唬鐮�,鍙礋璐ｇ儹鍔涘浘鐨勫睍鐜�====================================*/
